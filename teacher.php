...
extract($_GET);
$req = "select cin, nom, prenom, email, sexe
    from teacher 
...
else
{
    ...
    $req = "select cin, nom, prenom, email, sexe from teacher ";
}
...
<header class="header">
   ...
   <div class="principal">
    <div class="content">
        <fieldset>
        <legend><h2>Teachers List</h2></legend>
            <div class="top">
                <a href="addTeacher.php">Nouveau</a>
                <div>
                    <form>
            ...
            <table>
                ...
                ?>
                <tr>
                    <td><?php echo $lignes['cin']?></td>
                    <td><?php echo $lignes['nom']?></td>
                    <td><?php echo $lignes['prenom']?></td>
                    <td><?php echo $lignes['email']?></td>
                    <td><?php echo $lignes['sexe']?></td>
                    <td align="center">
                    <a onclick = "return confirm('voulez vous modifié cet enseignant')"
                    href="editTeacher.php?cin=<?php echo $lignes['cin']?>">
                    <img src="img/edit.png" alt="">
                    </a>
                    <td align="center">
                    <a onclick = "return confirm('voulez vous supprimé cet Enseingant')"
                    href="deleteTeacher.php?cin=<?php echo $lignes['cin']?>">
